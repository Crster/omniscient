...
import { MdOutlineFemale, MdOutlineGroup, MdOutlineHowToVote, MdOutlineMale } from "react-icons/md";
    ...
    <>
      ...
      <div className="flex flex-wrap gap-8">
        <div>
          ...
          <Image priority alt="Sample Graph1" height={289} src="/sample-graph.svg" width={498} />
        </div>
