...
const schema = z.object({
  ...
  voter: z.object({
    ...
    precinctNo: z.string().min(1).optional(),
...
export type editVoterRequest = z.infer<typeof schema>;

export function createEditVoterRequest(input: z.input<typeof schema>) {
